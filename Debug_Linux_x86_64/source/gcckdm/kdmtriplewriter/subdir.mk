...
source/gcckdm/kdmtriplewriter/%.o: ../source/gcckdm/kdmtriplewriter/%.cc
	...
	g++-4.5 -I"/home/myusuf3/Builds/gcckdm/include" -I/usr/lib/gcc/x86_64-linux-gnu/4.5/plugin/include -O0 -g3 -Wall -c -fmessage-length=0 -fPIC -Wno-deprecated -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
