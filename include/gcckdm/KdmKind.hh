...
private:
  ...
  /**
   * Conversion constructor to convert this ParameterKind object to an int
   */
  operator int() const
  {
	return mId;
  ...
  /**
   * Return the literal that this ParameterKind Object represents
   */
  std::string const & name() const
  {
	return mName;
